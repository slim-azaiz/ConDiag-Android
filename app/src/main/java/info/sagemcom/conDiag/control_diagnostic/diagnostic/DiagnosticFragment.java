package info.sagemcom.conDiag.control_diagnostic.diagnostic;
...
import info.sagemcom.conDiag.adapter.DiagnosticAdapter;
...
import static info.sagemcom.conDiag.control_diagnostic.diagnostic.DiagnosticActivity.url;
import static info.sagemcom.conDiag.login.Login.dataConditionalAccess;
import static info.sagemcom.conDiag.login.Login.dataIdentification;
import static info.sagemcom.conDiag.login.Login.dataLoader;
import static info.sagemcom.conDiag.login.Login.dataMemory;
import static info.sagemcom.conDiag.login.Login.dataNetwork;
import static info.sagemcom.conDiag.login.Login.dataNvmem;
import static info.sagemcom.conDiag.login.Login.dataSoftware;
import static info.sagemcom.conDiag.login.Login.dataSysInfo;
import static info.sagemcom.conDiag.login.Login.dataTuner;
import static info.sagemcom.conDiag.login.Login.dataVirtualTuner;
import static info.sagemcom.conDiag.utils.Config.DIAGNOSTIC_LOG;
import static info.sagemcom.conDiag.utils.Config.isWifiAvailable;
