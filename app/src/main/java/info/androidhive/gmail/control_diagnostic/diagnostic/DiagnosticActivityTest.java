...
public class DiagnosticActivityTest extends BaseActivity implements BottomNavigation.OnMenuItemSelectionListener {

    static final String TAG = DiagnosticActivityTest.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewGroup root = (ViewGroup) findViewById(R.id.CoordinatorLayout01Test);
        LoopBarView loopBarView = (LoopBarView)findViewById(R.id.endlessView);
        ...
        if (null != viewPager) {
            ...
            getBottomNavigation().setOnMenuChangedListener(new BottomNavigation.OnMenuChangedListener() {
                ...
                public void onMenuChanged(final BottomNavigation parent) {
                    ...
                    viewPager.setAdapter(new ViewPagerAdapter(DiagnosticActivityTest.this, parent.getMenuItemCount()));
